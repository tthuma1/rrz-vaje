...
def ik_newton_dh(target_pos, q0, dh_params, tol=1e-6, max_iter=100, lr=0.5):
	...
	for k in range(max_iter):
        ...
        # Izračunamo gradiente (odvode) vseh sklepov (J) in izračunamo, za koliko bi morali spremeniti vsak
		# parameter, da bi se v smeri gradienta premaknili tako, da se premaknemo za trenuten error.
		# Ker je pri rotacijskih sklepih gradient odvisen od trenutne rotacije, ne bomo v prvo pravilno izračunali,
		# ampak rabimo več iteracij. Learning rate nam omili overshooting.
		try:
